...
var Credits = new Schema({
    ...
    Credit_num: {type: String,  required: true},   // Credits_num number
    Credit_Date: {type: Date, default: Date.now, required: true},
    expire_Date: {type: Date, default: Date, default: null},

});

module.exports = mongoose.model('Credit', Credits);